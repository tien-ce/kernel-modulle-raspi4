...
static int __init my_init_module(void)
{
	...
	if(major < 0) {
		printk("Hello cdev - error registering character device\n");
		return major;
	}
...
static void __exit my_cleanup_module(void)
{
	...
	printk("Hello cdev - character device unregistered\n");
}
...
static ssize_t my_read(struct file* file, char __user* buf, size_t count, loff_t* offset)
{
	printk("Hello_cdev - read file\n");
	return 0; // Return 0 to indicate end of file
}

static int my_open(struct inode* inode, struct file* file)
{
	printk("Hello_cdev - open file\n");
	return 0; // Return 0 to indicate success
}

static int my_close(struct inode* inode, struct file* file)
{
	printk("Hello_cdev - close file\n");
	return 0; // Return 0 to indicate success
}

static ssize_t my_write(struct file* file, const char __user* buf, size_t count, loff_t* offset)
{
	printk("Hello_cdev - write file\n");
